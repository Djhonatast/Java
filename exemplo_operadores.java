...
import java.util.Scanner;//importando a classe scanner(pega tudo que tem escrito no scanner e importa para usa-las no codigo).
class exemplo_operadores{
    
    public static void main(String[] args){
int A;
int B;
Scanner s = new Scanner(System.in); //variavel para ler informações no termina (entrada de dados).
